  ...
  return (
    <div className="relative w-full h-[100vh] overflow-hidden flex">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center">
        <div className=" w-full h-[20%] flex lg:order-1 border-yellow-600 border-2">
        ...
        <div className=" w-full h-[15%] flex flex-col justify-center items-center lg:order-3 border-yellow-600 border-2">
