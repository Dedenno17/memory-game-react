  ...
  return (
    <div className="relative w-full h-[100vh] overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 bg-red-400 flex flex-col items-center">
        <div className="border-2 w-full h-[20%] flex">
        ...
        <div className="border-2 w-full h-[15%] flex flex-col justify-center items-center">
        ...
        <div className="flex border-2 w-full h-[55%]">
